...
namespace TasKagıtMAkas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //random1 =>bilgisayar seçeneği=kağıt
            //random2=> bilgisayar seçenği=makas
            //4.görev kazananı yazdırınız.
            //5.görev tekrar oynamak istiyor msunuz diye sorunuz.
            //6.skor tutunuz
            //7.görev oyun sürdükçe skoru güncelleyınız
            ...
            while (exitKey!="e")
            {
                ...
                Console.WriteLine("Choose [r]ock,[p]layer,[s]cissors or [e]xit");
                string playerMove = "";
                GetInput:
